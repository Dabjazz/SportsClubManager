 ...
 * @author Lucia
 */
public class SelectTeamsHelper
        extends javax.swing.JFrame {

    private SelectedSportsValue sportParent;
    private SelectedPlayerTeamsValue playerParent;
    private SelectTrainerTeamsValue trainerParent;
     ...
     */
    public SelectTeamsHelper(List<ITypeOfSportDto> allSports, SelectedSportsValue sportParent, SelectedPlayerTeamsValue playerParent, SelectTrainerTeamsValue trainerParent) {
        this.sportParent = sportParent;
        this.playerParent = playerParent;
        this.trainerParent = trainerParent;
        this.allSports = allSports;
        selectedTeams = new LinkedList<IClubTeamDto>();
        initComponents();
        setVisible(true);
    }
    ...
    private Object[] getTeamsArray() {
        List<IClubTeamDto> clubTeamsBySport = (LinkedList<IClubTeamDto>)sportParent.getClubTeamsBySport((ITypeOfSportDto)comboSports.getSelectedItem());
        return clubTeamsBySport.toArray(new Object[clubTeamsBySport.size()]);
    }
    
    private void btnFinishActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinishActionPerformed

        if (playerParent != null) {
            playerParent.playerTeamsSelected(selectedTeams);
        }
        if (trainerParent != null) {
            trainerParent.trainerTeamsSelected(selectedTeams);
        }
        closeThisWindows();
