        ...
        extends javax.swing.JFrame
{
     ...
     */
    public SelectTeamsHelper(List<ITypeOfSportDto> allSports, AbstractMainForm parent, boolean player)
    {
    ...
    /**
     Creates new form SelectSports
     */
    public SelectTeamsHelper(List<ITypeOfSportDto> allSports, boolean player)
    {
        this.allSports = allSports;
        this.player = player;
        selectedTeams = new LinkedList<IClubTeamDto>();
    ...
    private void updateListTeamsModel()
    {
        ...
        {
            Object[] strings = new Object[10];//getTeamsArray();
...
//        if (player)
//        {
//            parent.setPlayerClubTeams(selectedTeams);
//        }
//        else
//        {
