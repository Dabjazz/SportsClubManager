...
//    }
    public SearchChangeMemberServiceMapper()
    {
        this.service = lookupSearchChangeMemberBeanRemote();
    }
    ...
    private ISearchChangeMemberRemote lookupSearchChangeMemberBeanRemote()
    {
        try
        {
            Context c = new InitialContext();
            return (ISearchChangeMemberRemote) c.lookup("java:comp/env/SearchChangeMemberBean");
